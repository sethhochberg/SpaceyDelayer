...
*/
CSpaceyDelayer::~CSpaceyDelayer(void)
{
...
*/
bool __stdcall CSpaceyDelayer::initialize()
{
	// Add your code here
...
*/
bool __stdcall CSpaceyDelayer::prepareForPlay()
{
	// Add your code here:
...
Function to process UI data into useful variables for member objects. Boolean flag just allows processing to happen.

*/

void CSpaceyDelayer::setDelayVariables(bool bCook)
{
	m_DDL_Left.m_fDelay_ms = m_fFirstTap_ms;
	m_DDL_Right.m_fDelay_ms = m_fFirstTap_ms;

	m_DDL_Left.m_fFeedback_pct = m_fFeedback_pct;
	m_DDL_Right.m_fFeedback_pct = m_fFeedback_pct;

	m_DDL_Left.m_fWetLevel_pct = m_fWetness*100;
	m_DDL_Right.m_fWetLevel_pct = m_fWetness*100;

	m_fTapSize = m_fTapSize_ms*((float)m_nSampleRate/1000.0);
...
*/
bool __stdcall CSpaceyDelayer::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	...
	if(uNumInputChannels == 1 && uNumOutputChannels == 2)
		pOutputBuffer[1] = xn_l;

	// Stereo-In, Stereo-Out (INSERT Effect)
	if(uNumInputChannels == 2 && uNumOutputChannels == 2)
	{	float xn_r = pInputBuffer[1];
		float yn_r = 0.0;
		m_DDL_Right.processAudioFrame(&xn_r, &yn_r, 1, 1);
		if(m_uMultipleTaps == On)
		{
			yn_r = (yn_r + m_DDL_Right.getPastSample((int)m_fTapSize));
			yn_r = (yn_r + m_DDL_Right.getPastSample((int)m_fTapSize*2));
			yn_r = yn_r * 0.33; //scale back to original-ish amplitude after 3 delay sums
		}
		pOutputBuffer[1] = m_fWetness*yn_r + (1.0 - m_fWetness)*xn_r;
	}
...
//
bool __stdcall CSpaceyDelayer::userInterfaceChange(int nControlIndex)
{
...
*/
bool __stdcall CSpaceyDelayer::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
*/
bool __stdcall CSpaceyDelayer::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CSpaceyDelayer::processVSTAudioBuffer(float** ppInputs, float** ppOutputs,
...
bool __stdcall CSpaceyDelayer::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CSpaceyDelayer::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CSpaceyDelayer::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CSpaceyDelayer::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CSpaceyDelayer::midiClock()
{
...
bool __stdcall CSpaceyDelayer::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CSpaceyDelayer::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
	...
	ui0.fInitUserFloatValue = 100.000000;
	ui0.fInitUserDoubleValue = 0;
	ui0.fInitUserUINTValue = 0;
	ui0.m_pUserCookedIntData = NULL;
	ui0.m_pUserCookedFloatData = &m_fFirstTap_ms;
	ui0.m_pUserCookedDoubleData = NULL;
	ui0.m_pUserCookedUINTData = NULL;
	ui0.cControlUnits = "mSecs                                                           ";
	ui0.cVariableName = "m_fFirstTap_ms";
	ui0.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui0.dPresetData[0] = 100.000000;ui0.dPresetData[1] = 0.000000;ui0.dPresetData[2] = 0.000000;ui0.dPresetData[3] = 0.000000;ui0.dPresetData[4] = 0.000000;ui0.dPresetData[5] = 0.000000;ui0.dPresetData[6] = 0.000000;ui0.dPresetData[7] = 0.000000;ui0.dPresetData[8] = 0.000000;ui0.dPresetData[9] = 0.000000;ui0.dPresetData[10] = 0.000000;ui0.dPresetData[11] = 0.000000;ui0.dPresetData[12] = 0.000000;ui0.dPresetData[13] = 0.000000;ui0.dPresetData[14] = 0.000000;ui0.dPresetData[15] = 0.000000;
	ui0.cControlName = "First Tap Time";
	...
	ui0.nGUIRow = 1;
	ui0.nGUIColumn = 1;
	ui0.uControlTheme[0] = 0; ui0.uControlTheme[1] = 9; ui0.uControlTheme[2] = 0; ui0.uControlTheme[3] = 0; ui0.uControlTheme[4] = 0; ui0.uControlTheme[5] = 1; ui0.uControlTheme[6] = 0; ui0.uControlTheme[7] = 3329330; ui0.uControlTheme[8] = 0; ui0.uControlTheme[9] = 11119017; ui0.uControlTheme[10] = 1; ui0.uControlTheme[11] = 15790320; ui0.uControlTheme[12] = 1; ui0.uControlTheme[13] = 15790320; ui0.uControlTheme[14] = 3; ui0.uControlTheme[15] = 15790320; ui0.uControlTheme[16] = 15790320; ui0.uControlTheme[17] = 1; ui0.uControlTheme[18] = 15790320; ui0.uControlTheme[19] = 15790320; ui0.uControlTheme[20] = 0; ui0.uControlTheme[21] = 0; ui0.uControlTheme[22] = 0; ui0.uControlTheme[23] = 9; ui0.uControlTheme[24] = 0; ui0.uControlTheme[25] = 0; ui0.uControlTheme[26] = 0; ui0.uControlTheme[27] = 0; ui0.uControlTheme[28] = 0; ui0.uControlTheme[29] = 0; ui0.uControlTheme[30] = 0; ui0.uControlTheme[31] = 0; 
	...
	ui1.fInitUserFloatValue = 100.000000;
	ui1.fInitUserDoubleValue = 0;
	ui1.fInitUserUINTValue = 0;
	ui1.m_pUserCookedIntData = NULL;
	ui1.m_pUserCookedFloatData = &m_fTapSize_ms;
	ui1.m_pUserCookedDoubleData = NULL;
	ui1.m_pUserCookedUINTData = NULL;
	ui1.cControlUnits = "mSecs                                                           ";
	ui1.cVariableName = "m_fTapSize_ms";
	ui1.cEnumeratedList = "SEL1,SEL2,SEL3";
	ui1.dPresetData[0] = 100.000000;ui1.dPresetData[1] = 0.000000;ui1.dPresetData[2] = 0.000000;ui1.dPresetData[3] = 0.000000;ui1.dPresetData[4] = 0.000000;ui1.dPresetData[5] = 0.000000;ui1.dPresetData[6] = 0.000000;ui1.dPresetData[7] = 0.000000;ui1.dPresetData[8] = 0.000000;ui1.dPresetData[9] = 0.000000;ui1.dPresetData[10] = 0.000000;ui1.dPresetData[11] = 0.000000;ui1.dPresetData[12] = 0.000000;ui1.dPresetData[13] = 0.000000;ui1.dPresetData[14] = 0.000000;ui1.dPresetData[15] = 0.000000;
	ui1.cControlName = "Tap Spacing";
	...
	ui1.nGUIRow = 1;
	ui1.nGUIColumn = 2;
	ui1.uControlTheme[0] = 0; ui1.uControlTheme[1] = 9; ui1.uControlTheme[2] = 0; ui1.uControlTheme[3] = 0; ui1.uControlTheme[4] = 0; ui1.uControlTheme[5] = 0; ui1.uControlTheme[6] = 0; ui1.uControlTheme[7] = 3329330; ui1.uControlTheme[8] = 0; ui1.uControlTheme[9] = 11119017; ui1.uControlTheme[10] = 1; ui1.uControlTheme[11] = 15790320; ui1.uControlTheme[12] = 1; ui1.uControlTheme[13] = 15790320; ui1.uControlTheme[14] = 3; ui1.uControlTheme[15] = 15790320; ui1.uControlTheme[16] = 15790320; ui1.uControlTheme[17] = 1; ui1.uControlTheme[18] = 15790320; ui1.uControlTheme[19] = 15790320; ui1.uControlTheme[20] = 0; ui1.uControlTheme[21] = 0; ui1.uControlTheme[22] = 0; ui1.uControlTheme[23] = 88; ui1.uControlTheme[24] = 0; ui1.uControlTheme[25] = 0; ui1.uControlTheme[26] = 0; ui1.uControlTheme[27] = 0; ui1.uControlTheme[28] = 0; ui1.uControlTheme[29] = 0; ui1.uControlTheme[30] = 0; ui1.uControlTheme[31] = 0; 
	...
	ui2.nGUIRow = 1;
	ui2.nGUIColumn = 3;
	ui2.uControlTheme[0] = 0; ui2.uControlTheme[1] = 9; ui2.uControlTheme[2] = 0; ui2.uControlTheme[3] = 0; ui2.uControlTheme[4] = 0; ui2.uControlTheme[5] = 1; ui2.uControlTheme[6] = 0; ui2.uControlTheme[7] = 3329330; ui2.uControlTheme[8] = 0; ui2.uControlTheme[9] = 11119017; ui2.uControlTheme[10] = 1; ui2.uControlTheme[11] = 15790320; ui2.uControlTheme[12] = 1; ui2.uControlTheme[13] = 15790320; ui2.uControlTheme[14] = 3; ui2.uControlTheme[15] = 15790320; ui2.uControlTheme[16] = 15790320; ui2.uControlTheme[17] = 1; ui2.uControlTheme[18] = 15790320; ui2.uControlTheme[19] = 15790320; ui2.uControlTheme[20] = 0; ui2.uControlTheme[21] = 0; ui2.uControlTheme[22] = 0; ui2.uControlTheme[23] = 169; ui2.uControlTheme[24] = 0; ui2.uControlTheme[25] = 0; ui2.uControlTheme[26] = 0; ui2.uControlTheme[27] = 1; ui2.uControlTheme[28] = 0; ui2.uControlTheme[29] = 0; ui2.uControlTheme[30] = 0; ui2.uControlTheme[31] = 0; 
	...
	ui3.m_pUserCookedFloatData = &m_fFeedback_pct;
	ui3.m_pUserCookedDoubleData = NULL;
	ui3.m_pUserCookedUINTData = NULL;
	ui3.cControlUnits = "%                                                               ";
	ui3.cVariableName = "m_fFeedback_pct";
	...
	ui3.nGUIRow = 1;
	ui3.nGUIColumn = 4;
	ui3.uControlTheme[0] = 0; ui3.uControlTheme[1] = 9; ui3.uControlTheme[2] = 0; ui3.uControlTheme[3] = 0; ui3.uControlTheme[4] = 0; ui3.uControlTheme[5] = 1; ui3.uControlTheme[6] = 0; ui3.uControlTheme[7] = 3329330; ui3.uControlTheme[8] = 0; ui3.uControlTheme[9] = 11119017; ui3.uControlTheme[10] = 1; ui3.uControlTheme[11] = 15790320; ui3.uControlTheme[12] = 1; ui3.uControlTheme[13] = 15790320; ui3.uControlTheme[14] = 3; ui3.uControlTheme[15] = 15790320; ui3.uControlTheme[16] = 15790320; ui3.uControlTheme[17] = 1; ui3.uControlTheme[18] = 15790320; ui3.uControlTheme[19] = 15790320; ui3.uControlTheme[20] = 0; ui3.uControlTheme[21] = 0; ui3.uControlTheme[22] = 0; ui3.uControlTheme[23] = 255; ui3.uControlTheme[24] = 0; ui3.uControlTheme[25] = 0; ui3.uControlTheme[26] = 0; ui3.uControlTheme[27] = 0; ui3.uControlTheme[28] = 0; ui3.uControlTheme[29] = 0; ui3.uControlTheme[30] = 0; ui3.uControlTheme[31] = 0; 
	...
	ui4.m_pUserCookedUINTData = &m_uTapeFilter;
	ui4.cControlUnits = "";
	ui4.cVariableName = "m_uTapeFilter";
	ui4.cEnumeratedList = "On,Off";
	...
	ui4.nGUIRow = -1;
	ui4.nGUIColumn = -1;
	ui4.uControlTheme[0] = 0; ui4.uControlTheme[1] = 0; ui4.uControlTheme[2] = 0; ui4.uControlTheme[3] = 0; ui4.uControlTheme[4] = 16777215; ui4.uControlTheme[5] = 0; ui4.uControlTheme[6] = 0; ui4.uControlTheme[7] = 0; ui4.uControlTheme[8] = 0; ui4.uControlTheme[9] = 0; ui4.uControlTheme[10] = 0; ui4.uControlTheme[11] = 0; ui4.uControlTheme[12] = 0; ui4.uControlTheme[13] = 0; ui4.uControlTheme[14] = 0; ui4.uControlTheme[15] = 0; ui4.uControlTheme[16] = 0; ui4.uControlTheme[17] = 0; ui4.uControlTheme[18] = 0; ui4.uControlTheme[19] = 0; ui4.uControlTheme[20] = 0; ui4.uControlTheme[21] = 0; ui4.uControlTheme[22] = 1; ui4.uControlTheme[23] = 198; ui4.uControlTheme[24] = 172; ui4.uControlTheme[25] = 0; ui4.uControlTheme[26] = 0; ui4.uControlTheme[27] = 0; ui4.uControlTheme[28] = 0; ui4.uControlTheme[29] = 0; ui4.uControlTheme[30] = 0; ui4.uControlTheme[31] = 0; 
	...
	ui5.m_pUserCookedUINTData = &m_uMultipleTaps;
	ui5.cControlUnits = "";
	ui5.cVariableName = "m_uMultipleTaps";
	ui5.cEnumeratedList = "On,Off";
	...
	ui5.cControlName = "Multiple Taps";
	...
	ui5.nGUIRow = -1;
	ui5.nGUIColumn = -1;
	ui5.uControlTheme[0] = 0; ui5.uControlTheme[1] = 0; ui5.uControlTheme[2] = 0; ui5.uControlTheme[3] = 0; ui5.uControlTheme[4] = 16777215; ui5.uControlTheme[5] = 0; ui5.uControlTheme[6] = 0; ui5.uControlTheme[7] = 0; ui5.uControlTheme[8] = 0; ui5.uControlTheme[9] = 0; ui5.uControlTheme[10] = 0; ui5.uControlTheme[11] = 0; ui5.uControlTheme[12] = 0; ui5.uControlTheme[13] = 0; ui5.uControlTheme[14] = 0; ui5.uControlTheme[15] = 0; ui5.uControlTheme[16] = 0; ui5.uControlTheme[17] = 0; ui5.uControlTheme[18] = 0; ui5.uControlTheme[19] = 0; ui5.uControlTheme[20] = 0; ui5.uControlTheme[21] = 0; ui5.uControlTheme[22] = 1; ui5.uControlTheme[23] = 15; ui5.uControlTheme[24] = 170; ui5.uControlTheme[25] = 0; ui5.uControlTheme[26] = 0; ui5.uControlTheme[27] = 0; ui5.uControlTheme[28] = 0; ui5.uControlTheme[29] = 0; ui5.uControlTheme[30] = 0; ui5.uControlTheme[31] = 0; 
